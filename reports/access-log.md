...
最終更新: 2026-09-21 / 台帳: `$WASSHOY_CACHE_DIR/access.tsv` (89,227 行) / 集計: `python pipeline/access_report.py`
...
| ├ ページ取得 (fetch) | 72,186 |
| ├ robots.txt 取得 | 980 |
| └ 失敗 (HTTPエラー/接続失敗) | 15,992 |
| robots.txt により取得しなかった (denied) | 68 |
| 1ホスト上限で取得しなかった (capped) | 0 |
| 応答のあったホスト数 | 1,959 |
| 問い合わせのみで応答の無かったホスト数 (DNS不在等) | 6,215 |
