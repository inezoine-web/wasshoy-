...
最終更新: 2026-09-22 / 台帳: `$WASSHOY_CACHE_DIR/access.tsv` (95,938 行) / 集計: `python pipeline/access_report.py`
...
| ├ ページ取得 (fetch) | 76,588 |
| ├ robots.txt 取得 | 1,281 |
| └ 失敗 (HTTPエラー/接続失敗) | 17,994 |
| robots.txt により取得しなかった (denied) | 74 |
| 1ホスト上限で取得しなかった (capped) | 0 |
| 応答のあったホスト数 | 2,136 |
| 問い合わせのみで応答の無かったホスト数 (DNS不在等) | 6,757 |
