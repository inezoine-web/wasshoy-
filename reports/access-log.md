...
最終更新: 2026-09-19 / 台帳: `$WASSHOY_CACHE_DIR/access.tsv` (66,400 行) / 集計: `python pipeline/access_report.py`
...
| ├ ページ取得 (fetch) | 58,918 |
| ├ robots.txt 取得 | 0 |
| └ 失敗 (HTTPエラー/接続失敗) | 7,482 |
| robots.txt により取得しなかった (denied) | 0 |
| 1ホスト上限で取得しなかった (capped) | 0 |
| 応答のあったホスト数 | 1,455 |
| 問い合わせのみで応答の無かったホスト数 (DNS不在等) | 4,897 |
